...
import mx.edu.ittepic.mydb03.entidades.Usuario;
import mx.edu.ittepic.mydb03.utilidades.Utilidades;
        ...
        public void onClick(View view) {
            switch (view.getId()){
                case R.id.imageButton:
                    ...
                    if (registros==-1){
                        Toast.makeText(MainActivity.this,"No se agregó el renglón ",Toast.LENGTH_SHORT).show();

                    }else{
                        Toast.makeText(MainActivity.this,"SI SE AGREGÓ EL RENGLÓN "+ registros,Toast.LENGTH_SHORT).show();
                    }
                /*
                    break;
