package mx.edu.ittepic.relojencanvas;
...
public class MainActivity extends AppCompatActivity {
    ...
    public class Relog extends View {
        ...
        private void init(Context context, AttributeSet attrs) {
            ...
            ColorFondoPintura.setColor(Color.rgb(216, 27, 27));
            ...
            numero = new Paint();
            numero.setTextSize(70);
            numero.setColor(Color.WHITE);
        ...
        private void numeros(Canvas canvas) {
            canvas.drawText("12", 500, 100, numero);
            canvas.drawText("3", 1000, 550, numero);
            canvas.drawText("6", 550, 1050, numero);
            canvas.drawText("9", 50, 550, numero);
